...
public class TpEnsemble {
	...
	"ajouter une valeur � E[n1]",
	"ajouter un intervalle de valeurs � E[n1]",
	"d�terminer si x appartient � E[n1]",
	"afficher le cardinal de E[n1]",
	"E[n1] <-- compl�mentaire(E[n1])",
	"E[n1] <-- diff�rence(E[n1],E[n2])",
	"E[n1] <-- diff�renceSym�trique(E[n1],E[n2])",
	"d�terminer si E[n1] et E[n2] sont �gaux",
	"d�terminer si E[n1] est inclus dans E[n2]",
	"E[n1] <-- intersection(E[n1],E[n2])",
	"retirer une valeur � E[n1]",
	"retirer un intervalle de valeurs � E[n1]",
	"E[n1] <-- union(E[n1],E[n2])",
	"d�terminer si E[n1] est vide",
	"arr�t de l'ex�cution"
    };

    private static String[] nomBouton =
    {"Affecter", "AffecterVide", "Afficher", "Ajouter", "AjouterIntervalle",
     "Appartient", "Cardinal", "Compl�mentaire", "Diff�rence",
     "Diff�renceSym�trique", "Egal", "InclusDans", "Intersection",
    ...
    private static void executer(int i) { // traitements associ�s aux boutons
	...
	case  3 : E[lireN(1)].add(lireVal("valeur � ajouter : ")); break;
	...
	case 13 : E[lireN(1)].remove(lireVal("valeur � retirer : "));
	    break;
	...
	return lireEnt("  num�ro d'ensemble n" + i + " : ", 0, MAXENS - 1);
    }
